...
public class Books extends javax.swing.JFrame {
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
        ...
        try {
            ...
            if(k == 1)
            {
                ...
                bookID.setText(Integer.toString(0));
                category.setText("");
                bName.setText("");
                author.setText("");
                copies.setText(Integer.toString(0));
    ...
    try {
        ...
        pst = con.prepareStatement("INSERT INTO issued (book_id, category, name, author, copies) VALUES (?, ?, ?, ?, ?)");
        pst.setInt(1, Book_ID);
        pst.setString(2, Category);
        pst.setString(3, Book_Name);
        pst.setString(4, Author);
        ...
        // Decrement book quantity in Books table
